...
///////////////////////////////
    ...
    function readUint16LE(dataview, byteOffset, littleEndian){
        var buffer = dataview.buffer._data,
            offset = byteOffset + dataview.byteOffset,
            order  = littleEndian ? le2 : be2;
    ...
    function readUint32LE(dataview, byteOffset, littleEndian){
        var buffer = dataview.buffer._data,
            offset = byteOffset + dataview.byteOffset,
            order  = littleEndian ? le4 : be4;
    ...
    function writeUInt16LE(dataview, byteOffset, value, littleEndian){
        var buffer = dataview.buffer._data,
            order  = littleEndian ? le2 : be2,
            offset = byteOffset + dataview.byteOffset;
    ...
    function writeUInt32LE(dataview, byteOffset, value, littleEndian){
        var buffer = dataview.buffer._data,
            order  = littleEndian ? le4 : be4,
            offset = byteOffset + dataview.byteOffset;
